import { g as Mt } from "./_commonjsHelpers-d4512b9c.js";
function Wt(U, v) {
  for (var ne = 0; ne < v.length; ne++) {
    ...
    if (typeof W != "string" && !Array.isArray(W)) {
      for (const H in W)
        if (H !== "default" && !(H in U)) {
          const G = Object.getOwnPropertyDescriptor(W, H);
          G && Object.defineProperty(U, H, G.get ? G : {
            enumerable: !0,
            get: () => W[H]
          });
        }
...
var Nr = { exports: {} }, He = {}, Mr = { exports: {} }, g = {};
/**
 * @license React
...
function Vt() {
  if (ct)
    return g;
  ct = 1;
  var U = Symbol.for("react.element"), v = Symbol.for("react.portal"), ne = Symbol.for("react.fragment"), W = Symbol.for("react.strict_mode"), H = Symbol.for("react.profiler"), G = Symbol.for("react.provider"), ae = Symbol.for("react.context"), ee = Symbol.for("react.forward_ref"), $ = Symbol.for("react.suspense"), re = Symbol.for("react.memo"), L = Symbol.for("react.lazy"), Y = Symbol.iterator;
  function te(n) {
  ...
  function ve(n, s, h) {
    ...
    if (s != null)
      for (C in s.ref !== void 0 && (k = s.ref), s.key !== void 0 && (P = "" + s.key), s)
        N.call(s, C) && !le.hasOwnProperty(C) && (_[C] = s[C]);
    ...
    if (n && n.defaultProps)
      for (C in T = n.defaultProps, T)
        _[C] === void 0 && (_[C] = T[C]);
    return { $$typeof: U, type: n, key: P, ref: k, props: _, _owner: K.current };
  }
  function Re(n, s) {
    return { $$typeof: U, type: n.type, key: s, ref: n.ref, props: n.props, _owner: n._owner };
  }
  function Ce(n) {
  ...
  function Q(n, s, h, C, _) {
    ...
    if (k)
      return k = n, _ = _(k), n = C === "" ? "." + J(k, 0) : C, ie(_) ? (h = "", n != null && (h = n.replace(we, "$&/") + "/"), Q(_, s, h, "", function(V) {
        return V;
  ...
  return g.Children = { map: B, forEach: function(n, s, h) {
    ...
    return n;
  } }, g.Component = oe, g.Fragment = ne, g.Profiler = H, g.PureComponent = I, g.StrictMode = W, g.Suspense = $, g.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Se, g.cloneElement = function(n, s, h) {
    if (n == null)
    ...
    if (s != null) {
      ...
      for (w in s)
        N.call(s, w) && !le.hasOwnProperty(w) && (C[w] = s[w] === void 0 && T !== void 0 ? T[w] : s[w]);
    }
    ...
    return { $$typeof: U, type: n.type, key: _, ref: P, props: C, _owner: k };
...
function Ut() {
  return ft || (ft = 1, function(U, v) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      B.ReactDebugCurrentFrame = le, B.ReactCurrentActQueue = N;
      function se(e) {
        {
      ...
      function be(e, r, a, o, i) {
        ...
        if (l) {
          ...
          if (Fe(E)) {
            var j = "";
            O != null && (j = ye(O) + "/"), be(E, r, j, "", function(Nt) {
              return Nt;
            });
          } else
        ...
        var A, D, M = 0, q = o === "" ? tr : o + Rr;
        if (Fe(e))
          for (var vr = 0; vr < e.length; vr++)
            A = e[vr], D = q + Ae(A, vr), M += be(A, r, a, D, i);
        else {
          var Lr = I(e);
          if (typeof Lr == "function") {
            var ut = e;
            Lr === ut.entries && (Me || se("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), Me = !0);
            for (var $t = Lr.call(ut), it, Lt = 0; !(it = $t.next()).done; )
              A = it.value, D = q + Ae(A, Lt++), M += be(A, r, a, D, i);
          } else if (p === "object") {
            var st = String(e);
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, i), i.default;
      ...
      function u(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === G || e === ee || Q || e === ae || e === Y || e === te || J || e === Ie || Ce || Ue || we || typeof e == "object" && e !== null && (e.$$typeof === fe || e.$$typeof === X || e.$$typeof === $ || e.$$typeof === re || e.$$typeof === L || // This needs to include all possible module reference object
...
Check the top-level render call using <` + a + ">.");
      ...
      function tt(e, r, a) {
        ...
        if (!o) {
          ...
          p ? i += p : i += Xr();
          var l;
          e === null ? l = "null" : Fe(e) ? l = "array" : e !== void 0 && e.$$typeof === W ? (l = "<" + (pe(e.type) || "Unknown") + " />", i = " Did you accidentally export a JSX literal instead of a component?") : l = typeof e, d("React.createElement: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", l, i);
        }
      ...
      function jt(e) {
        if (dr === null)
          try {
            ...
            dr = a.call(U, "timers").setImmediate;
          } catch {
            dr = function(i) {
      ...
      v.Children = Ft, v.Component = _, v.Fragment = G, v.Profiler = ee, v.PureComponent = V, v.StrictMode = ae, v.Suspense = Y, v.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = B, v.cloneElement = Dt, v.createContext = ur, v.createElement = xt, v.createFactory = It, v.createRef = hr, v.forwardRef = kr, v.isValidElement = _e, v.lazy = Pr, v.memo = c, v.startTransition = kt, v.unstable_act = At, v.useCallback = Z, v.useContext = R, v.useDebugValue = ce, v.useDeferredValue = vt, v.useEffect = z, v.useId = yt, v.useImperativeHandle = ir, v.useInsertionEffect = x, v.useLayoutEffect = F, v.useMemo = Ee, v.useReducer = b, v.useRef = m, v.useState = S, v.useSyncExternalStore = ht, v.useTransition = pt, v.version = ne, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
  }(Ke, Ke.exports)), Ke.exports;
}
process.env.NODE_ENV === "production" ? Mr.exports = Vt() : Mr.exports = Ut();
var yr = Mr.exports;
const Yt = /* @__PURE__ */ Mt(yr), Ht = /* @__PURE__ */ Wt({
  __proto__: null,
  default: Yt
}, [yr]);
/**
...
function Bt() {
  if (lt)
    return He;
  lt = 1;
  var U = yr, v = Symbol.for("react.element"), ne = Symbol.for("react.fragment"), W = Object.prototype.hasOwnProperty, H = U.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, G = { key: !0, ref: !0, __self: !0, __source: !0 };
  function ae(ee, $, re) {
    var L, Y = {}, te = null, X = null;
    re !== void 0 && (te = "" + re), $.key !== void 0 && (te = "" + $.key), $.ref !== void 0 && (X = $.ref);
    for (L in $)
      W.call($, L) && !G.hasOwnProperty(L) && (Y[L] = $[L]);
...
function zt() {
  return dt || (dt = 1, process.env.NODE_ENV !== "production" && function() {
    var U = yr, v = Symbol.for("react.element"), ne = Symbol.for("react.portal"), W = Symbol.for("react.fragment"), H = Symbol.for("react.strict_mode"), G = Symbol.for("react.profiler"), ae = Symbol.for("react.provider"), ee = Symbol.for("react.context"), $ = Symbol.for("react.forward_ref"), re = Symbol.for("react.suspense"), L = Symbol.for("react.suspense_list"), Y = Symbol.for("react.memo"), te = Symbol.for("react.lazy"), X = Symbol.for("react.offscreen"), fe = Symbol.iterator, Ie = "@@iterator";
    function oe(t) {
    ...
    var ie = !1, N = !1, K = !1, le = !1, ve = !1, Re;
    Re = Symbol.for("react.module.reference");
    function Ce(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === W || t === G || ve || t === H || t === re || t === L || le || t === X || ie || N || K || typeof t == "object" && t !== null && (t.$$typeof === te || t.$$typeof === Y || t.$$typeof === ae || t.$$typeof === ee || t.$$typeof === $ || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
...
` + m[x].replace(" at new ", " at ");
    ...
    var Te = Object.prototype.hasOwnProperty, Oe = {}, Xe = ue.ReactDebugCurrentFrame;
    function Pe(t) {
      if (t) {
    ...
    var ge = ue.ReactCurrentOwner, gr = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function Cr(t, u, c, f, R) {
      {
        ...
        c !== void 0 && (Ye(c), m = "" + c), br(u) && (Ye(u.key), m = "" + u.key), _r(u) && (z = u.ref, Er(u, R));
        for (S in u)
        ...
        return Rr(t, m, z, R, f, ge.current, b);
      }
    }
...
Check the top-level render call using <` + c + ">.");
    ...
    var Pr = Or, kr = Tr;
    Ge.Fragment = W, Ge.jsx = Pr, Ge.jsxs = kr;
  }()), Ge;
}
